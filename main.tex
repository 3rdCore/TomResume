...
\section{Honors and Awards}
 \resumeSubHeadingListStart
      \resumeProjectHeading
      {FRQNT doctoral training scholarship }{Mar. 2025} 
      \resumeProjectHeading
...
\section{Reviewing and Community service}
 \resumeSubHeadingListStart
        \resumeProjectHeading
      {Tea Talks Committee member – Research seminal held at Mila  }{2025}         \resumeProjectHeading
      {Organiser: AI Summer School in Benin (EEIA) – Supporting underserved communities }{2025}        \resumeProjectHeading
      {Reviewer:  NeurIPS CALM Workshop, MAIS, HRAIM}{2024}
      \resumeProjectHeading
      {Reviewer: Constraint Programming (CP)}{2023} 
