...
\begin{center}
    ...
    \begin{tabular}{c@{\hspace{1cm}}c@{\hspace{1cm}}c}
        ...
        \href{https://twitter.com/tommarty13}{\faTwitter \,\, Twitter} % Aligned with location
    \end{tabular}
\end{center}
...
\section{Industry and Academic Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
        \resumeItem{Developped WorkArena : an open-source Benchmark and Gym environment for evaluating Agent at solving common-knowledge tasks on a Web Browser}
      \resumeItemListEnd
      \resumeSubheading
...
\section{Other Projects}
    \resumeSubHeadingListStart
        \resumeProjectHeading
          {\textbf{Leveraging Information Theory to create better optimizers}$|$ \emph{Python}}{May. 2024 -- }
          \resumeItemListStart
            \resumeItem{Work in progress...}
          \resumeItemListEnd
        \resumeProjectHeading
          {\textbf{On the necessity of human insight to improve natural adversarial robustness}}{Mar. 2024 -- }
          \resumeItemListStart
            \resumeItem{Work in progress...}
          \resumeItemListEnd
        \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{Paper accepted at ICML 2024, Vienna}
