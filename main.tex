...
\section{Education}
  \resumeSubHeadingListStart
      ...
      %\end{itemize}
    \resumeSubheading
      {B.Sc. in Computer Science, minor in Applied Mathematics}{Sep. 2018 -- Aug. 2021}
...
\section{Research Interest}
        \begin{itemize}
            ...
            \vspace{-5pt}
            \item \textbf{Applications} : ML for biology, Robust Machine Learning, Open-Ended Decision Making
        \end{itemize}
...
\section{Honors and Awards}
 \resumeSubHeadingListStart
      \resumeProjectHeading
      {FRQNT doctoral training scholarship: 25000\$ (x4 years)}{Mar. 2025} 
      \resumeProjectHeading
      {Distinguished Paper Award at CP conference}{Sept. 2023} 
      \resumeProjectHeading
      {MITACS Accelerate scholarship: 30000\$ }{Mar. 2023}
      \resumeProjectHeading
      {Oustanding Investment Mention, Ecole Polytechnique de Paris}{Jul. 2022}
      \resumeProjectHeading
      {Vallet Fondation scholarships for outstanding CPGE students: 5000\euro{} (x2 years)}{2018}
  \resumeSubHeadingListEnd
...
\section{Skills \& Hobbies}
 \begin{itemize}[leftmargin=0.15in, label={}]
    ...
    \textbf{Languages}{: French : Native $|$ English : Fluent $|$ Russian : Primary }} \\
     \textbf{Developer Toolbox}{: Pytorch, Lightning, Git, Hydra, HPC, WandB, SLURM, CI Testing} \\
