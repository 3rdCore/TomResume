...
\section{Research Interest}
        \begin{itemize}
            \item \textbf{Broad interest} : Deep Learning, Generative modeling and Operational Research
            \vspace{-5pt}
            \item \textbf{Methodological interest} : Flow-based model, Causality, Generalization, Information Theory
            \vspace{-5pt}
