...
\begin{center}
    ...
    \begin{tabular}{c@{\hspace{1cm}}c@{\hspace{1cm}}c}
        ...
        \href{https://github.com/3rdCore}{\faGithub\,\,Github} & % Aligned with globe
        \href{https://www.linkedin.com/in/tom-marty/}{\faLinkedin \,\,LinkedIn} & % Aligned with envelope
        \href{https://twitter.com/Tom__Marty}{\faTwitter \,\, Twitter} % Aligned with location
    \end{tabular}
\end{center}
...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {"Classe préparatoire" Intensive multi-disciplinary preparation - GPA 4.00 - Top 0.1\% national}{Paris, France}
...
\begin{tcolorbox}[enhanced, sharp corners, colback=white, colframe=black!10!white, boxrule=0.5mm, left=10pt, right=10pt, top=6pt, bottom=3pt]
    ...
    Constraint Journal, 2024 \hfill \textit{*under review} 
\end{tcolorbox}
...
\section{Other Projects}
    \resumeSubHeadingListStart
        \resumeProjectHeading
          {\textbf{Leveraging Information Theory to create better optimizers} $|$ \emph{Python}, \emph{Pytorch Lightning}}{May. 2024 -- }
          \resumeItemListStart
            \resumeItem{Work in progress...}
          \resumeItemListEnd
        \resumeProjectHeading
          {\textbf{On the Necessity of Human Insight and Causality to Improve Adversarial Robustness}}{Mar. 2024 -- }
          \resumeItemListStart
            \resumeItem{Work in progress...}
          \resumeItemListEnd
        \resumeProjectHeading
          {\textbf{WorkArena : an Open-Source Benchmark for evaluating Web Agents} $|$ \emph{Python}}{Apr. 2023 -- Mar. 2024}
          \resumeItemListStart
      ...
      \resumeProjectHeading
          ...
          \resumeItemListEnd
      \resumeProjectHeading
          {\textbf{Visit \href{https://3rdcore.github.io/}{\faLink \,my website} to delve into these projects...}}{}
    \resumeSubHeadingListEnd
%-----------Honors and Awards-----------
...
\section{Reviewing and Community service}
 \resumeSubHeadingListStart
        \resumeProjectHeading
      {Reviewer, Montréal Artificial Intelligence Symposium — MAIS2024}{Sept. 2024}
      \resumeProjectHeading
      {Reviewer, Constraint Programming — CP2023}{August. 2023} 
