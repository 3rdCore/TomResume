...
\section{Research Interest}
        \begin{itemize}
            \item \textbf{Broad interest} : Deep Learning, Generative modeling, AI for Science
            \vspace{-5pt}
            \item \textbf{Methodological interest} : Diffusion model, Causality, Generalization, Information Theory
            \vspace{-5pt}
...
\section{Industry and Academic Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
      ...
      \resumeItemListEnd
      \resumeSubheading
      {Research Supervisor}{Jan. 2022 -- Sep. 2022}
...
\section{Other Projects}
    \resumeSubHeadingListStart
        \resumeProjectHeading
          {\textbf{Discrete flow matching for protein co-design aimed at pMHC:TCR binding}}{Sep. 2025 -- }
        \resumeProjectHeading
          {\textbf{Dissection of concept acquisition in protein Language Model}}{Sep. 2025 -- }
        \resumeProjectHeading
